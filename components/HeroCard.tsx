...
export default function HeroCard(props: CardProps) {
  return (
    <div className="md:flex w-2/3 mx-auto max-h-100 h-100 mt-40">
      ...
      <div className="bg-white border rounded-r-xl p-14 w-full">
        <div>
          <h1 className="text-4xl">{props.title}</h1>
          <h2 className="text-xl font-normal mt-2.5 flex">
        ...
        <button className="bg-orange-swadesh text-white pt-7 pb-7 pl-20 pr-20 rounded-xl mt-7">
          Invest now
